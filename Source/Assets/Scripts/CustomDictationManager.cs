...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class CustomDictationManager : Singleton<CustomDictationManager>, IInputSource
    {
#if UNITY_WSA || UNITY_STANDALONE_WIN
        /// <summary>
        ...
        /// </summary>
        public static TextMesh showDictation01;
        /// <summary>
        /// Attach to TextMeshManager.cs
        /// </summary>
        public static TextMeshManager newTextMesh;
        /// <summary>
        /// Object attach to Cursor Text
        /// </summary>
        public GameObject textMeshObject01;
        /// <summary>
        /// Object attach to TextMeshManager
        /// </summary>
        ...
        /// Private parameters
        /// </summary>
        //public static float initialSilenceTimeout = 3600f;
        //public static float autoSilenceTimeout = 3600f;
        //public static int recordingTime = 3600;
        ...
        protected override void Awake()
        {
            ...
            // Reset dictation result
            dictationResult = string.Empty;

            // Attach text mesh object
            showDictation01 = textMeshObject01.GetComponent<TextMesh>();
            newTextMesh = textManager.GetComponent<TextMeshManager>();

            // Initialization of Dictation Recognizer
        ...
        // Method For re-enable the Dictation Recording
        public void enableRecordingObject ()
        {
            Debug.Log("StartRecording ... ");
            StartCoroutine(StartRecording());
        }
        ...
        private void LateUpdate()
        {
            ...
            Debug.Log("AutoSilenceTimeoutSeconds: " + dictationRecognizer.AutoSilenceTimeoutSeconds);
            Debug.Log("InitialSilenceTimeoutSeconds: " + dictationRecognizer.InitialSilenceTimeoutSeconds);
            Debug.Log("Microphone "+ DeviceName + ": " + Microphone.IsRecording(DeviceName));
            Debug.Log("dictationRecognizer status: " + dictationRecognizer.Status);

            if (isComplete && !isTransitioning) {
                //&& dictationRecognizer.Status == SpeechSystemStatus.Stopped
                Debug.Log("Re-Start Recording ... ");
                //StartCoroutine(StopRecording());
                StartCoroutine(StartRecording());
            }
        }
        ...
        /// <returns></returns>
        public static IEnumerator StartRecording(float initialSilenceTimeout = 60f, float autoSilenceTimeout = 60f, int recordingTime = 60)
        {
            isComplete = false;
#if UNITY_WSA || UNITY_STANDALONE_WIN
            ...
            {
                Debug.Log("Dictation recognizer stoppted and failed to start!");
                isComplete = true;
                yield return null;
            }
        ...
        private static void DictationRecognizer_DictationHypothesis(string text)
        {
            ...
            if (dictationResult != "" || dictationResult != null)
            {
                showDictation01.text = dictationResult;
            }
            else
            {
                showDictation01.text = "Dictation result show here...";
            }
        }
